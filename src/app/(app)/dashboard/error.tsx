  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <BarChart3 size={24} style={{ color: "var(--color-loss)" }} />
      </div>
      ...
      <p style={{ color: "var(--color-gray-500)", maxWidth: 420, lineHeight: 1.6, fontSize: "0.85rem" }}>
        {error.message || "Could not load dashboard data. Your trading stats are safe."}
      </p>
      <div style={{ display: "flex", gap: "0.75rem", marginTop: "0.5rem" }}>
        <button onClick={() => router.push("/")} className="btn btn-secondary" style={{ display: "flex", alignItems: "center", gap: 6 }}>

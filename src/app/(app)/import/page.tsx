  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: "1.5rem" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(320px, 1fr))", gap: "1.5rem", alignItems: "start" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "1.5rem" }}>
          <div className="card" style={{ padding: "1.5rem", background: "var(--color-gray-900)", border: "1px solid var(--color-gray-800)", borderRadius: "12px", display: "flex", flexDirection: "column", gap: "1.25rem" }}>
          ...
          {/* Formats info card */}
          <div className="card" style={{ padding: "1.25rem", background: "var(--color-gray-900)", border: "1px solid var(--color-gray-800)", borderRadius: "12px" }}>
        ...
        <div style={{ height: "100%" }}>
          {preview ? (
            ...
            <div className="card" style={{ padding: "2.5rem 2rem", background: "var(--color-gray-900)", border: "1px solid var(--color-gray-800)", borderRadius: "12px", height: "100%", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", textAlign: "center", minHeight: "360px" }}>

...
import { AlertTriangle, RefreshCw, ArrowLeft, CalendarDays } from "lucide-react"
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <CalendarDays size={24} style={{ color: "var(--color-loss)" }} />
      </div>
      ...
      <p style={{ color: "var(--color-gray-500)", maxWidth: 420, lineHeight: 1.6, fontSize: "0.85rem" }}>
        {error.message || "Could not load calendar data."}
      </p>

...
const endIndex = lines.findIndex((l, i) => i > startIndex && l.includes('/* ── Integrations ──────────────────────────────────────── */'));

if (startIndex !== -1 && endIndex !== -1) {
  const newCss = `/* ── Features (Bento Grid) ──────────────────────────────────────────── */
.marketing-features {
  padding: 6rem 0;
  position: relative;
  overflow: hidden;
...
.marketing-bento-card.large { grid-column: span 2; grid-row: span 2; }
.marketing-bento-card.medium { grid-column: span 2; grid-row: span 1; }
.marketing-bento-card.small { grid-column: span 1; grid-row: span 1; }
.marketing-bento-card.wide { grid-column: span 4; grid-row: span 1; }
...
.bento-mockup-alert .dot { width: 8px; height: 8px; border-radius: 50%; margin-top: 6px; }
...
`;
  ...
  console.log('Successfully replaced features CSS');
} else {
